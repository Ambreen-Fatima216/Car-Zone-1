const locationData = {
    dubai: {
        ...
        mapUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3609.431264875416!2d55.3670!3d25.2223!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjXCsDEzJzIwLjMiTiA1NcKwMjInMDEuMiJF!5e0!3m2!1sen!2sae!4v1620650000000!5m2!1sen!2sae",
        directions: "https://maps.app.goo.gl/3fX3P5"
    },
    sharjah: {
        ...
        mapUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3607.345678901234!2d55.4567!3d25.3456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjXCsDIwJzQ0LjIiTiA1NcKwMjcnMjQuMSJF!5e0!3m2!1sen!2sae!4v1620650000000!5m2!1sen!2sae",
        directions: "https://maps.app.goo.gl/9wY2X"
    }
};
...
function initContactParticles() {
    if (!contactCanvas || !contactCtx) return;
    resizeContactCanvas();
    contactParticles = [];
    for (let i = 0; i < 150; i++) contactParticles.push(new ContactParticle());
}

function animateContactCanvas() {
    if (!contactCanvas || !contactCtx) return;
    contactCtx.clearRect(0, 0, contactCanvas.width, contactCanvas.height);
    contactParticles.forEach((p) => { p.update(); p.draw(); });
    window.requestAnimationFrame(animateContactCanvas);
}

window.addEventListener("mousemove", (e) => { contactMouse.x = e.clientX; contactMouse.y = e.clientY; });
